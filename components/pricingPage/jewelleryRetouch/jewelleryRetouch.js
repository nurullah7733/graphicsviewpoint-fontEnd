      ...
      <div className="px-4">
        ...
        <div className="py-12">
          <PricingTableHeader
            before={before}
            after={after}
            headerText={"Jewellery Retouch Services"}
          />
        </div>
        {/*Pricing Table */}
        <div className="flex flex-wrap justify-center -mx-4 gap-y-7">
          <PricingTable
            headline={"Simple Jewellery Retouch Services"}
            price={"1.50"}
            description={
          ...
          />
          <PricingTable
            headline={"Medium Jewellery Retouch Services"}
            price={"2.10"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
          ...
          />
          <PricingTable
            headline={"Complex Jewellery Retouch Services"}
            price={"4.50"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
