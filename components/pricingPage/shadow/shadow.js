...
const Shadow = () => {
  const before =
    "/assets/img/all_services_afterbefore/Shadow/GVP_Shadow-Service-01.jpg";
  const after =
    "/assets/img/all_services_afterbefore/Shadow/GVP_Shadow-Service-02.jpg";
  return (
      ...
      <div className="px-4">
        ...
        <div className="py-12">
          <PricingTableHeader
            before={before}
            after={after}
            headerText={"Shadow Services"}
          />
        </div>
        {/*Pricing Table */}
        <div className="flex flex-wrap justify-center -mx-4 gap-y-7">
          <PricingTable
            headline={"Simple Shadow Services"}
            price={"0.75"}
            description={
          ...
          />
          <PricingTable
            headline={"Medium Shadow Services"}
            price={"1.90"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
          ...
          />
          <PricingTable
            headline={"Complex Shadow Services"}
            price={"3.50"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
