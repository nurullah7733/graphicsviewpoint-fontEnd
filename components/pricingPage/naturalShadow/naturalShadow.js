...
const NaturalShadow = () => {
  const before = "/assets/img/all_services_afterbefore/Natural-Shadow/1.jpg";
  const after = "/assets/img/all_services_afterbefore/Natural-Shadow/2.jpg";
  return (
      ...
      <div className="px-4">
        ...
        <div className="py-12">
          <PricingTableHeader
            before={before}
            after={after}
            headerText={"Natural Shadow Services"}
          />
        </div>
        {/*Pricing Table */}
        <div className="flex flex-wrap justify-center -mx-4 gap-y-7">
          <PricingTable
            headline={"Simple Natural Shadow Services"}
            price={"0.75"}
            description={
          ...
          />
          <PricingTable
            headline={"Medium Natural Shadow Services"}
            price={"1.50"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
          ...
          />
          <PricingTable
            headline={"Complex Natural Shadow Services"}
            price={"2.70"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
