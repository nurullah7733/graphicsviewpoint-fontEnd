...
const Ghost = () => {
  const before = "/assets/img/all_services_afterbefore/Ghost-mannequin/1.jpg";
  const after = "/assets/img/all_services_afterbefore/Ghost-mannequin/2.jpg";
  return (
      ...
      <div className="px-4">
        ...
        <div className="py-12">
          <PricingTableHeader
            before={before}
            after={after}
            headerText={"Ghost Mannequin Services"}
          />
        </div>
        {/*Pricing Table */}
        <div className="flex flex-wrap justify-center -mx-4 gap-y-7">
          <PricingTable
            headline={"Simple Ghost Mannequin Services"}
            price={"0.95"}
            description={
          ...
          />
          <PricingTable
            headline={"Medium Ghost Mannequin Services"}
            price={"1.30"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
          ...
          />
          <PricingTable
            headline={"Complex Ghost Mannequin Services"}
            price={"3.50"}
            description={
              "Here are some additional details that you may want to include in your pricing plan description:"
            }
